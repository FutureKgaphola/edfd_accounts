...
const Banking = () => {
    const { data, isLoading, error } = useFetchLeadBanking();
    const { loading, error: errorp, success, submitForm } = useUpdateLeadBanking();
                ...
                <div className="mt-4 grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <div className="flex gap-1">
                            {ServerFileName ? (<HiCloudDownload onClick={() => handleDownload(user_id, UserEmail, ServerFileName, 'leadproofBankng')} className="hover:cursor-pointer" width={35} height={35} />) : null}
