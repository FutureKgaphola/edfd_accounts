            ...
            <form className="max-w-md gap-4 w-fit border shadow rounded p-4 pt-3">
                <div className=" mt-4">
                    ...
                    <div>
                        ...
                        <TextInput sizing="sm" onChange={(e: any) => setPhysical(e.target.value)} value={physical} theme={customInputBoxTheme} color={"focuscolor"} icon={HiUserAdd} id="name" type="text" placeholder="Physical Address" required />
                    </div>
                    {
                        switch1 ? null : (<div>
                            <div className="mb-2 block">
                            ...
                            <TextInput sizing="sm" onChange={(e: any) => SetPostal(e.target.value)} value={postal} theme={customInputBoxTheme} color={"focuscolor"} icon={HiUserAdd} id="Lname" type="text" placeholder="Postal Address" required />
                        </div>)
                    }
                    <div>
                        <div className="mb-2 block">
                            <Label htmlFor="postal" value="Pdf copy of Proof of Address" />
                        </div>
