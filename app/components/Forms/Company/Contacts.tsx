                ...
                <p className="mt-1">Marital Status: {marital}</p>
                {
                    marital == "Married" ? (
                        <div className="relative mt-6">
                            <div className="max-w-md w-fit border shadow rounded p-4 pt-3 grid gap-2 grid-cols-2">
                                <p className="text-sm absolute left-2 -top-3 bg-appGreen text-white font-poppinsRegular rounded p-1">Spouce's Details</p>
                                <div>
                                    <div>
                                        <div className="mb-2 block">
                                ...
                                <div>
                                    <div>
                                        ...
                                        <TextInput sizing="sm"
                                            min={10}
                                            maxLength={10}
                                            onChange={(e: any) => SetSpoucephone(e.target.value)} value={Spoucephone} theme={customInputBoxTheme} color={"focuscolor"} id="phone" type="text" required />
                                    </div>
                                    <div>
                                        <div className="mb-2 block">
                                            <Label htmlFor="idno" value="SA-ID *" />
