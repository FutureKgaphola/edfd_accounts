...
export const mailClientVeficationToken=async(info:any)=>{
    ...
    try {
        const defaultDomain = process.env.DOMAIN || 'http://localhost:3000';
            ...
            transporter.sendMail({
                ...
                html: `<p>Hi ${name}, welcome to EDFD Loans</p><br>
                    <p>Just as a final step to get your account active, kindly click on the privided link below.</p></br>
