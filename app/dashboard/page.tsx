                    ...
                    <div className="mb-5 flex -top-11 items-center justify-center">
                        <div className="bg-slate-50 p-4 rounded-md place-self-center mt-4">
                            <Alert color="green" className="mb-2">
                                ...
                                {hydrated && isLoading && <p>Preparing your profile .....</p>}
                            </Alert>
                            <div className="flex flex-wrap items-center justify-center gap-2">

                                <Card className="max-w-sm flex items-center justify-center">
                                    <Image src={user} className="h-12 w-12 self-center" alt="User Icon" />
                                    <Button onClick={() => HandleProfileTab("owner")} size="xs" theme={customsubmitTheme} color="success">Lead Profile</Button>
                                    <p className="font-thin text-xs self-center">Contacts,Address & Banking</p>
                                </Card>
                                <Card className="max-w-sm flex items-center justify-center">
                                    ...
                                    <p className="font-thin text-xs self-center">Identification,Address & Banking</p>
                                </Card>
                                <Card className="max-w-sm flex items-center justify-center">
                                    <Image src={accept} className="h-12 w-12 self-center" alt="..." />
                                    <Button disabled={companies?.length == 0 ? true : false} onClick={() => HandleProfileTab("apply")} size="xs" theme={customsubmitTheme} color="success">Apply for a Loan</Button>
